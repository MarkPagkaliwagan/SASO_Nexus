...
const AdminDepartment = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto mt-12 p-10 bg-gray-50 dark:bg-gray-900 rounded-3xl shadow-xl border border-gray-200 dark:border-gray-700">
      <h2 className="text-4xl font-extrabold mb-12 text-gray-800 dark:text-gray-100 text-center flex items-center justify-center gap-3">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 space-y-6">
          <div>
            <label className="block font-semibold text-gray-700 dark:text-gray-200 mb-2 text-lg">📝 Announcement Details</label>
            <textarea
              className="w-full min-h-[180px] p-4 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 text-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
          ...
          <div>
            <label className="block font-semibold text-gray-700 dark:text-gray-200 mb-2 text-lg flex items-center gap-2">
              <FaBuilding /> Select Department
            </label>
            <select
              className="w-full p-4 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 text-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
              value={department}
          ...
          <div>
            ...
            <input
              ...
              className="mb-4 block w-full text-lg text-gray-900 dark:text-gray-100"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="mb-8 block w-full text-lg text-gray-900 dark:text-gray-100"
            />
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
          ...
          {(announcement || image || video) ? (
            <div className="p-6 border rounded-xl bg-gray-50 dark:bg-gray-700 space-y-4">
              <div className="font-semibold mb-2 text-lg text-gray-900 dark:text-gray-100">{department}</div>
              <div className="mb-4 text-gray-700 dark:text-gray-200" dangerouslySetInnerHTML={{ __html: announcement.replace(/\n/g, "<br />") }} />
              {image && (
                <img
      ...
      <div className="mt-16">
        <h3 className="text-3xl font-bold mb-6 text-gray-800 dark:text-gray-100 flex items-center gap-2">
        ...
        <div className="flex flex-col gap-6">
          {announcements.map((a) => (
            <div
              key={a.id}
              className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden max-w-xl mx-auto"
            >
              {/* Media */}
              {a.image && (
                <img
              ...
              {/* Text Content */}
              <div className="p-4">
                <div className="font-semibold text-gray-800 dark:text-gray-100 mb-1">{a.department}</div>
                <div className="text-gray-700 dark:text-gray-200 text-sm line-clamp-3" dangerouslySetInnerHTML={{ __html: a.announcement.replace(/\n/g, "<br />") }} />
