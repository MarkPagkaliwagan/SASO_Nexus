    ...
    <div className="flex flex-col h-full w-full">
        ...
        <nav className="flex flex-col space-y-2">
          ...
          {menuItems.map((item, idx) => (
            <button
              ...
              className="flex items-center gap-3 hover:text-black text-left px-3 py-2 rounded-lg hover:bg-yellow-500 w-full truncate transition-all"
            >
              {item.icon}
              <AnimatePresence>
                {(isExpanded || isMobile) && (
          ...
          <div>
            ...
            <button
              ...
              className="flex items-center gap-3 justify-between hover:text-black text-left px-3 py-2 rounded-lg hover:bg-yellow-500 w-full truncate transition-all"
            >
              ...
              {openDropdown && (isExpanded || isMobile) && (
                ...
                >
                  <button
                    ...
                    className="text-sm text-left px-2 py-1 rounded hover:bg-yellow-500/60"
                  >
                    Announcement
                  </button>
                  <button
      ...
      <div className="p-4 border-t border-yellow-400/10">
        <button
          ...
          className="w-full bg-emerald-900 hover:bg-yellow-500 px-4 py-2 rounded-lg text-white flex items-center gap-3 justify-center transition"
        >
          <CheckCircle size={18} />
          <AnimatePresence>
            {(isExpanded || isMobile) && (
