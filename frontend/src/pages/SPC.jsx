...
export default function History() {
  // simplified animation variants for other sections
  const upVariant = {
  ...
  return (
    <div className="space-y-16 p-8">
      {/* Brief History (no transition) */}
      <div className="bg-gradient-to-r from-amber-100 via-amber-50 to-amber-100 
                      p-12 rounded-3xl shadow-2xl border border-yellow-300 
                      max-w-7xl mx-auto w-full">
        <h2 className="text-5xl font-serif flex items-center gap-4 text-green-900">
          <FaBookOpen className="text-5xl text-yellow-600" /> Brief History of
          the San Pablo Colleges
        </h2>
        <div className="mt-8 text-gray-800 leading-relaxed text-justify space-y-6 text-xl">
      ...
      {/* Container para sa ibang sections */}
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        <motion.div
          ...
          className="bg-white border-l-8 border-green-600 p-8 rounded-2xl shadow-lg"
        >
          <h2 className="text-3xl font-bold flex items-center gap-3 text-green-800">
            <FaBullseye className="text-3xl text-green-600" /> Vision
          </h2>
        ...
        >
          <h2 className="text-3xl font-bold flex items-center gap-3 text-green-900 italic">
            <FaChalkboardTeacher className="text-3xl text-green-600" /> Mission
          </h2>
          <p className="mt-4 text-gray-700 text-lg">
        ...
        >
          <h2 className="text-3xl font-bold text-green-800 mb-6 flex items-center gap-3">
            <FaUsers className="text-3xl text-yellow-500" /> SPC Core Values
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {[
              ...
              <motion.div
                ...
                whileInView="show"
                viewport={{ once: false, amount: 0.2 }}
                className={`${value.color} p-6 rounded-2xl shadow-md flex flex-col gap-4`}
              >
                <div className="flex items-center gap-4">
                  <div className="text-3xl">{value.icon}</div>
                  <div>
                    <h3 className="font-semibold text-xl">{value.title}</h3>
                    <p className="font-medium text-green-900">{value.acronym}</p>
                  </div>
                </div>
        ...
        <motion.div
          ...
          whileInView="show"
          viewport={{ once: false, amount: 0.2 }}
          className="bg-white border-2 border-yellow-400 p-8 rounded-2xl shadow-lg"
        >
          <h2 className="text-3xl font-bold flex items-center gap-3 text-yellow-700">
            <FaMedal className="text-3xl text-yellow-500" /> Graduate Attributes
          </h2>
          ...
          <ul className="mt-6 space-y-3 text-gray-700 text-lg list-disc list-inside">
