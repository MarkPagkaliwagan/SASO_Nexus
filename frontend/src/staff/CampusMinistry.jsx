      ...
      <div className="flex flex-col h-full w-full">
            ...
            {(isExpanded || isMobile) && (
              ...
              >
                ...
                <div className="text-xs text-yellow-200 truncate">
                  Campus Ministry Staff Dashboard
                </div>
              </motion.div>
            )}
          </AnimatePresence>
        ...
        <div className="p-4 border-t border-yellow-400/10">
          <button
            ...
            className={`w-full bg-yellow-700 px-4 py-2 rounded-lg text-white flex items-center gap-3 justify-center transition${logoutHover}`}
          >
            <CheckCircle size={18} />
            <AnimatePresence>
              {(isExpanded || isMobile) && (
        ...
        {activePanel === "Dashboard" && (
          <div className="relative w-full min-h-screen flex flex-col items-center justify-start text-center overflow-hidden pt-32 md:pt-40">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center gap-8">
              ...
              <span className="mt-4 text-2xl md:text-3xl font-medium text-yellow-700 hover:text-yellow-500 transition-colors duration-300">
                Staff Dashboard
              </span>
            </div>
          </div>
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          ...
          >
            ...
            <p className="text-gray-600 mt-2">
              You are now logged in as authorized Campus Ministry Staff.
            </p>
            <button
